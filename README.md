...
In this project I will be updating the Opnsense firewall and adding features like Intrusion Detection and Intrusion Prevention System(IPS) to my firewall. Furthermore, I will be adding custom rules (through suricata) to my firewall to help identifiy potential port scans on the system.
